...
public class UsersDAO {
  ...
  public com.webanalytics.hbase.dto.User getUser(String user)
    throws IOException {
    HTableInterface users = pool.getTable(TABLE_NAME);
  ...
  public List<com.webanalytics.hbase.dto.User> getUsers()
    throws IOException {
    HTableInterface users = pool.getTable(TABLE_NAME);

    ResultScanner results = users.getScanner(mkScan());
    ArrayList<com.webanalytics.hbase.dto.User> ret
      = new ArrayList<com.webanalytics.hbase.dto.User>();
  ...
  private static class User
    extends com.webanalytics.hbase.dto.User {
